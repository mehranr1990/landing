...
export default function HeroSection() {
  return (
    <section className="relative overflow-hidden  text-white">
      ...
      {/* Main Hero Content */}
      <div className="relative z-10 px-6 md:px-16 lg:px-24 py-16 md:py-26" style={{ backgroundImage: 'url(/background/hero.jpg)', backgroundSize: 'cover', }}>
        <div className="mx-auto max-w-7xl flex flex-col md:flex-row items-center justify-between gap-12">
          ...
          <div className="flex-1 text-center md:text-left">
            ...
            <div className="mt-8 flex flex-col sm:flex-row gap-4 justify-center md:justify-start">
              <a
                href="#get-started"
                className="rounded-full bg-teal-500 hover:bg-teal-600 text-white font-semibold w-[150px] h-[50px] flex items-center justify-center"
              >
                Get Started
              </a>
              <a
                href="#demo"
                className="rounded-full border-2 border-white hover:bg-white/10 text-white font-semibold  w-[150px] h-[50px] flex items-center justify-center"
              >
                Watch Demo
              </a>
            </div>
      ...
      {/* Stats Section */}
      <div className="relative z-10 bg-[#FFFBF0] text-black py-16">
        <div className="px-6 md:px-16 lg:px-24 py-12">
          <div className="mx-auto max-w-7xl">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-5xl mx-auto ">
              {/* Card 1 */}
              <div className="bg-white rounded-3xl border-2 border-orange-300 p-8  hover:shadow-xl transition-shadow">
